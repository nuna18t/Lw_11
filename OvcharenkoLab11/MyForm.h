...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(42, 29);
			...
			this->label1->Text = L"Temperature Far:";
			...
			this->label2->Text = L"Temperature Cel:";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		try
		{
			TF = Convert::ToInt32(textBox1->Text);
			TC = ((TF - 32) * 5 / 9);
			TF = 0;
			textBox2->Text = Convert::ToString(TC);
		...
		catch (...)
		{
			TF = 0;
			TC = 0;
			MessageBox::Show(" is not int number", "Error");
		}
